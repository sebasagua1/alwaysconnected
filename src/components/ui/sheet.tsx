...
// z-[65]: por encima de las fichas propias (z-[60], p. ej. el detalle del
// evento en Mis eventos y en /event/:id, que es desde donde se abre «Invitar
// amigos») y por debajo de dialog, alert-dialog y popover (z-[70]), que se
// abren desde dentro de un sheet. En z-50 se abría DETRÁS de la ficha.
